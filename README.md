# IP_Hunter
### IP_Hunter is a Linux-based tool designed to gather information about any IP address. By running this tool, you can obtain various details about the IP address you specify.just run the tool using `./location.sh` command and give the ip adress , after sometime it provides many information about the ip adress.
## OS - Linux based os
